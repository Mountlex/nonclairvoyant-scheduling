cargo run --release -- exp1 -n 10 -l 10000 -a 1.1 -o exp1_s1.csv -p 1 --step-sigma 1 --num-sigma 100 
cargo run --release -- exp1 -n 10 -l 10000 -a 1.1 -o exp1_s10.csv -p 1 --step-sigma 10 --num-sigma 100 
